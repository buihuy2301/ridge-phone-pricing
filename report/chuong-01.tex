...
Một cửa hàng thu mua điện thoại cũ phải trả lời cùng một câu hỏi vài chục lần mỗi
ngày: chiếc máy đang cầm trên tay đáng bao nhiêu tiền. Người bán biết hãng máy,
dung lượng RAM, tuổi máy, màn hình có nứt hay không, giá lúc mới mua. Cách trả lời
đơn giản nhất là cho mỗi đặc điểm một trọng số rồi cộng lại, và khi đó việc định
giá quy về việc tìm bộ trọng số $w$ sao cho dự đoán sát giá thật nhất. Tìm $w$
chính là giải một bài toán tối ưu hóa, và toàn bộ báo cáo này nói về cách giải nó.
...
ellipsoid bị bóp dẹt thành một cái máng hẹp và dài; gradient khi đó gần như vuông
góc với trục của máng, nên phương pháp bậc một lao rất nhanh xuống đáy máng rồi bò
dọc theo máng chậm hơn nhiều bậc. Toàn bộ khó khăn mà chương~\ref{sec:mechanisms}
mô tả nằm ở hình ảnh này.
...
Đọc tới đây thì có một chỗ vướng cần giải quyết trước khi đi tiếp. Bài toán này đã
có nghiệm đóng ở \eqref{eq:closed-form}, tính được bằng một lần phân rã Cholesky.
Vậy chạy các thuật toán lặp để làm gì?
...
Một con số đặt trước để người đọc biết mình đang đi về đâu. Trên bài toán này, năm
