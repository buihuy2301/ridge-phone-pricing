...
hồ đã dừng, cùng chỗ với phép tính $f(w_k)$ và chuẩn gradient, nên nó không rơi
vào thời gian chạy được báo cáo; bộ đếm số lần đánh giá hàm cũng được khôi phục
sau mỗi lần ghi. Chi tiết cài đặt nằm ở mục~\ref{sec:recorder}.
...
\begin{table}[tp]
  \centering
  \caption{Thời gian đạt hai ngưỡng, đo trên cùng một máy. Cột giữa ứng với dung
    sai mười đơn vị tiền, cột phải ứng với một đơn vị.}
  \label{tab:two-thresholds}
  \begin{tabular}{lrrrr}
    \toprule
    & \multicolumn{2}{c}{$\eps_{\text{app}} = 4{,}0 \cdot 10^{-5}$}
    & \multicolumn{2}{c}{$\eps_{\text{app}} = 1{,}35 \cdot 10^{-6}$} \\
    \cmidrule(lr){2-3} \cmidrule(lr){4-5}
    Thuật toán & Vòng lặp & Thời gian (s) & Vòng lặp & Thời gian (s) \\
    \midrule
    Newton ($t = 1$)                  & 1  & \num{0.054} & 1  & \num{0.054} \\
    L-BFGS ($m = 20$)                 & 6  & \num{0.217} & 8  & \num{0.282} \\
    GD ($t = 2/L$)                    & 10 & \num{0.246} & 20 & \num{0.456} \\
    GD backtracking                   & 10 & \num{0.326} & 15 & \num{0.491} \\
    AGD + restart                     & 15 & \num{0.432} & 20 & \num{0.577} \\
    SGD bậc thang ($B = 64$)          & 21 & \num{1.703} & \multicolumn{2}{c}{không đạt} \\
    \bottomrule
  \end{tabular}
\end{table}

Nới dung sai từ một đơn vị lên mười đơn vị rút thời gian của các phương pháp bậc
một xuống khoảng một nửa, chẳng hạn gradient descent đi từ \SI{0.456}{\second}
còn \SI{0.246}{\second} (bảng~\ref{tab:two-thresholds}). Nhưng thay đổi đáng kể
hơn nằm ở dòng cuối: SGD bậc thang đạt ngưỡng nới sau 21 lượt duyệt dữ liệu,
trong khi ở ngưỡng chặt nó không đạt trong toàn bộ ngân sách 30 lượt. Nói cách
khác, chính dung sai đặt ra ở chương này quyết định SGD có được coi là phương
pháp dùng được hay không, chứ không phải bản thân thuật toán.
